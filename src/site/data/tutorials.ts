    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open your clinic dashboard", body: "Sign in and choose your clinic. The Dashboard is the starting point for appointments, patients, eye clinic work, finance and stock." },
          { title: "Open the Eye Clinic group", body: "The Eye Clinic group in the sidebar holds Eye Exams, Optical Prescriptions, Contact Lenses, Optical Orders, Diagnostics, Eye Results, Eye Charts and Surgery Bookings." },
          { title: "Use the other sidebar groups", body: "Open Patient Care for patients, appointments, the waiting list, schedules, consents and reviews. Use Finance for money matters, Reports for performance, and Inventory & Supply for frames, lenses and drugs." },
          { title: "Start from Eye Clinic Overview", body: "Choose Eye Clinic Overview for one clinic-wide view of exams today, prescriptions issued, active contact lens wearers, open optical orders, upcoming surgeries and diagnostic studies." },
          { title: "Check your access", body: "If a page is missing from your sidebar, ask an owner or admin to review your staff role. Access to clinical pages, billing and settings depends on that role." },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Add your team", body: "Open Staff, select Add Staff, and enter each person's details and role. Optometrists and assistants need clinical access; front-desk staff need appointments, orders and billing." },
          ...
          { title: "Add your services", body: "Open your service catalogue and add the visits you charge for, such as full eye examination, refraction, contact lens fitting, visual field test and follow-up review." },
          { title: "Do a practice run", body: "Register a test patient, book an appointment, record a short eye exam and delete the records afterwards so your team can practise safely." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Clinic Profile", body: "In Settings, choose the Clinic Profile tab and review the clinic name, address and contact details." },
          { title: "Upload your logo", body: "Select Upload Logo, choose the clinic logo, and check that it appears correctly before saving." },
          { title: "Turn on the right notifications", body: "Open Notifications and choose the switches for appointment reminders, payment alerts and low stock alerts so the team is warned about frames, lenses and drops running out." },
          { title: "Manage members and rooms", body: "If you are an admin, use Members & Roles to edit details or change a role, and set up your consulting and refraction rooms." },
          { title: "Save each change", body: "Select Save Changes after updating a settings tab, then reopen the tab to confirm the saved values are still present." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Staff Management", body: "Choose Staff from Administration. Every team member appears as a card with their name, specialty, role badge, status and phone number." },
          { title: "Start a new staff member", body: "Select Add Staff, then enter the person's full name. Full Name is the only required field." },
          { title: "Choose the role", body: "Clinical roles can open Eye Exams, Optical Prescriptions, Contact Lenses, Diagnostics, Eye Results and Eye Charts. Reception and assistant roles handle Optical Orders and bookings. Owners and admins see everything." },
          { title: "Create the login", body: "Complete the dialog so the staff member receives an account, then ask them to sign in and confirm their sidebar shows the pages they need." },
          { title: "Keep records current", body: "Edit a staff card when someone changes role, and mark leavers inactive so they no longer appear in booking lists." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Website Settings", body: "Choose Website Settings from Administration." },
          { title: "Write your clinic introduction", body: "Enter the clinic name, tagline, about text and contact details patients should see." },
          { title: "List your eye care services", body: "Add the services you want to advertise, such as eye examinations, glasses dispensing, contact lens fitting, glaucoma screening and cataract assessment." },
          { title: "Add opening hours and location", body: "Enter your hours, address and directions, then save the page." },
          { title: "Preview and publish", body: "Open the public preview, check every section reads correctly on a phone, then publish." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Shop Management", body: "Choose Shop Management from Administration." },
          { title: "Add a product", body: "Create the product with its name, description, price, images and stock. Typical items are frames, single vision and anti-glare lenses, contact lens solutions, lubricating drops and sunglasses." },
          { title: "Keep prices and stock accurate", body: "Update price and stock whenever your supplier costs or shelf counts change so patients are not sold items you do not have." },
          { title: "Process incoming orders", body: "Review new orders, move each one through its status as you prepare and hand it over, and check the payment before release." },
        ],
      },
      {
        ...
        level: "Advanced",
        steps: [
          { title: "Open Audit Log", body: "Choose Audit Log from Administration. Access is limited to owners and admins." },
          { title: "Filter to what you are checking", body: "Narrow the log by date, user or record type before you read it." },
          { title: "Read an entry", body: "Each entry shows the person, the action and the record affected, so you can trace an edited prescription, order amount or invoice." },
          { title: "Follow up correctly", body: "Open the original record to confirm the current values, and correct it there rather than in the log." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Enter contact details", body: "Complete the patient's name, phone number and other required contact fields." },
          { title: "Add useful history", body: "Record general medical history and anything that affects the eyes, such as diabetes, hypertension, allergies and current drops." },
          { title: "Search before you create", body: "Always search the name or phone number first. One record per patient keeps exams, prescriptions and orders together." },
          { title: "Save the record", body: "Complete the dialog, then search for the name or patient ID to confirm the patient is listed." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Find the patient", body: "On Patients, search by name, ID or phone, then select the patient." },
          { title: "Review the overview", body: "Check contact details, outstanding balance and recent activity at the top of the profile." },
          { title: "Open the Eye History tab", body: "The eye records tab summarises the patient's eye exams, optical prescriptions, contact lenses, optical orders, diagnostic studies and surgery in one place." },
          { title: "Jump to results and trends", body: "Use the links for the patient's fundus, OCT and visual field results, and for their eye charts and trends." },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Capture the background", body: "Record the presenting complaint, how long it has lasted, previous glasses or contact lens wear, eye surgery, family history of glaucoma and any current eye drops." },
          { title: "Document the visit", body: "Enter what the patient reported, what you found, your assessment and the plan, keeping right eye and left eye findings clearly separated." },
          { title: "Note the eye", body: "Use OD for the right eye, OS for the left and OU for both so nobody has to guess which eye a finding belongs to." },
          { title: "Review before saving", body: "Check the eye labels, measurements and follow-up instructions, then save the note." },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and file", body: "Select the patient, choose the file and enter the document details requested." },
          { title: "Name files so they are findable", body: "Include the document type and date, for example referral letter, OCT report or hospital discharge summary." },
          { title: "Complete the upload", body: "Finish the dialog to attach the document to the patient record." },
          { title: "Watch expiry alerts", body: "Return to Documents to review expiry alerts and remove a file when it should no longer be kept." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Consent Forms", body: "Choose Consent Forms from Patient Care and stay on Patient Consents for patient records." },
          { title: "Import the eye care library", body: "In Templates, import the standard eye care library. It includes general eye examination, pupil dilation, cataract surgery, refractive surgery, intravitreal injection, contact lens wear, ophthalmic imaging, consent for a minor and financial agreement forms." },
          ...
          { title: "Sign the form", body: "Open the patient consent and select Sign to record the patient's completed consent. Dilation and surgery consents must be signed before the procedure starts." },
          { title: "Keep templates ready", body: "Use New Template for your own wording, or upload a scanned form you already use on paper." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and service", body: "Select the patient, the optometrist and the visit type, such as full eye examination, refraction only, contact lens fitting, visual field test or post-operative review." },
          { title: "Allow enough time", body: "Book longer slots for first visits, dilated examinations and contact lens teaching, and shorter slots for collections and quick reviews." },
          { title: "Choose the time", body: "Use the date and time controls to select an available slot, switching between day, week and month views when you need a wider picture." },
          { title: "Save the booking", body: "Complete the dialog, then confirm the appointment appears in the schedule or list view." },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Find or add the patient", body: "Select the existing patient, or complete the patient details if this is their first visit." },
          { title: "Add the visit details", body: "Choose the clinician, the reason for the visit and any notes. Flag sudden vision loss, eye injury or severe pain so the patient is seen first." },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Open Waiting List", body: "Choose Waiting List to see the queue with its waiting, called, in progress and completed counts." },
          { title: "Call the next patient", body: "Select Call Next to move the next patient forward, or check a patient in directly from this page." },
          { title: "Keep dilated patients visible", body: "Note when drops were instilled so the patient is called back at the right time, and mark the visit complete when they leave." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Schedules", body: "Choose Schedules from Patient Care." },
          { title: "Select a staff member", body: "Pick the person whose hours you are setting." },
          { title: "Set working days and hours", body: "Turn each day on or off and enter the start, end and break times." },
          { title: "Block out non-clinical time", body: "Reserve time for surgery lists, home visits, admin and leave so those slots cannot be booked." },
          { title: "Save and check the calendar", body: "Save the schedule, then open Appointments to confirm the available slots match." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Eye Exams", body: "Choose Eye Exams from the Eye Clinic group and select New Exam. The Recent exams list shows each patient with their date, vision, diagnosis and a pressure badge." },
          { title: "Choose the patient and date", body: "Search the patient by name or phone in the picker, then set the exam date. On an existing exam the patient stays locked, so only the findings can be edited." },
          { title: "Record the complaint", body: "Enter the chief complaint in the patient's own words, for example blurred distance vision, headaches when reading or gritty eyes." },
          { title: "Enter vision for each eye", body: "Record unaided, aided and pinhole vision separately for the right eye (OD) and left eye (OS). Pinhole vision helps you tell a refractive problem from disease." },
          { title: "Record the pressures", body: "Choose the pressure method you used, then enter the reading in mmHg for each eye. Readings above 21 mmHg are flagged on the list and on the overview." },
          { title: "Examine and record the front of the eye", body: "Enter pupil findings and the anterior segment findings for each eye, covering lids, conjunctiva, cornea, anterior chamber and lens." },
          { title: "Record the fundus and cup/disc ratio", body: "Enter the fundus findings and the cup/disc ratio for each eye. A ratio of 0.6 or more is picked up on the glaucoma watch list." },
          { title: "Mark dilation", body: "Turn on the dilation toggle when the pupils were dilated for this exam, so the next clinician can interpret the findings correctly." },
          { title: "Finish with diagnosis and plan", body: "Enter your diagnosis, the plan and any notes, then select Save exam. Use the trash icon on a list row only to remove a record created in error." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Diagnostics", body: "Choose Diagnostics from the Eye Clinic group and select Record Study." },
          { title: "Choose the study and eye", body: "Select the patient, the study type, and whether it applies to the right eye, the left eye or both." },
          { title: "Enter the findings", body: "Type the measured values into the findings, using the standard short forms so they can be charted, for example RNFL 82, CMT 260, MD -3.4, PSD 2.1 or CDR 0.7." },
          { title: "Attach the report", body: "Add the file name and a link to the stored report or image so colleagues can open the original." },
          { title: "Save and filter", body: "Select Save study, then use the study type filter at the top of the list to find a group of studies quickly." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Eye Results", body: "Choose Eye Results from the Eye Clinic group." },
          { title: "Select the patient", body: "Use the patient card to pick a patient. The card also summarises their latest exam pressure, vision, cup/disc ratio and diagnosis." },
          { title: "Work through the groups", body: "Results are grouped into fundus, OCT, visual field and other, each with a count so you can see what is available." },
          { title: "Read the flagged values", body: "Each row shows the extracted measurements as badges and highlights abnormal ones, so you can spot a thinning nerve or worsening field at a glance." },
          { title: "Open the original file", body: "Select the file link on a row to open the stored report, and use the Graphs button to move to the trend view." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Eye Charts", body: "Choose Eye Charts from the Eye Clinic group." },
          { title: "Select the patient", body: "Pick the patient in the picker. The badges show how many fundus, OCT, visual field and other studies they have." },
          { title: "Read the trends", body: "Six charts plot pressure, cup/disc ratio, OCT nerve fibre thickness, central macular thickness, and visual field mean deviation and pattern standard deviation over time." },
          { title: "Compare the two eyes", body: "The right eye is drawn as a solid line and the left eye as a dashed line, so a change in one eye stands out." },
          { title: "Act on a worsening trend", body: "If a line is moving the wrong way, review the source studies, change treatment or refer, and book the next review." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Eye Clinic Overview", body: "Choose Eye Clinic Overview from the Overview group." },
          { title: "Check the activity cards", body: "Read exams today, prescriptions issued, active contact lens wearers, open optical orders, upcoming surgeries and diagnostic studies." },
          { title: "Check the money cards", body: "Review optical sales value, the amount still outstanding on orders, and the glasses that are ready for collection." },
          { title: "Work the alert lists", body: "Follow up raised pressure above 21 mmHg, the glaucoma watch list, today's theatre list, contact lens aftercare that is due and prescriptions expiring soon." },
          { title: "Start work from here", body: "Select New Eye Exam to go straight into recording a visit, and review the common diagnoses chart to see what your clinic is treating most." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Optical Prescriptions", body: "Choose Optical Prescriptions from the Eye Clinic group and select New Prescription." },
          { title: "Choose the patient and type", body: "Select the patient, then choose the prescription type: distance, reading, bifocal, progressive, computer or contact lens." },
          { title: "Set the dates", body: "Enter the issue date and the expiry date. Expiring prescriptions are listed on the Eye Clinic Overview so patients can be recalled." },
          { title: "Enter the right eye values", body: "In the right eye (OD) box, enter sphere, cylinder, axis, add and prism exactly as measured." },
          { title: "Enter the left eye values", body: "Repeat in the left eye (OS) box, and check the signs before you move on. A wrong sign means a wrong lens." },
          { title: "Add the fitting details", body: "Enter pupillary distance in mm, base curve, diameter, the lens brand and any notes for the dispenser." },
          { title: "Save and check", body: "Select Save prescription, then confirm the formatted values on the list row match what you measured." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Contact Lenses", body: "Choose Contact Lenses from the Eye Clinic group and select New Fitting." },
          { title: "Choose the patient and date", body: "Select the patient and set the fitting date." },
          { title: "Record the lens", body: "Enter the lens brand, the lens type and the wearing modality, then the base curve and diameter." },
          { title: "Enter the power for each eye", body: "Record the power for the right eye and the left eye separately." },
          { title: "Assess the fit", body: "Write your fit assessment, covering centration, movement, comfort and vision with the lens in place." },
          { title: "Book aftercare", body: "Set the aftercare date so the patient appears on the aftercare-due list on the Eye Clinic Overview." },
          { title: "Keep the status current", body: "Move the fitting from trial to dispensed, then to aftercare, or to discontinued if the patient stops wearing lenses." },
          { title: "Save the fitting", body: "Select Save fitting and confirm the status badge and aftercare date on the list row." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Optical Orders", body: "Choose Optical Orders from the Eye Clinic group and select New Order." },
          { title: "Identify the order", body: "Select the patient, then enter your order number and the order date so the job can be traced." },
          { title: "Record the frame", body: "Enter the frame brand, model and price the patient chose." },
          { title: "Record the lenses", body: "Choose the lens type and coating, then enter the lens price." },
          { title: "Add the lab and promised date", body: "Enter the lab or supplier and the date you promised the glasses, so you can see which jobs are late." },
          { title: "Record the money", body: "Enter the total amount and the amount paid. Any balance is shown in red on the list row." },
          { title: "Move the status along", body: "Update the status as the job progresses: ordered, at lab, ready, collected or cancelled. Ready orders appear as glasses awaiting collection on the overview." },
          { title: "Close the order", body: "When the patient collects, enter the delivered date, confirm the balance is settled, and select Save order." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open the patient's prescription", body: "On Optical Prescriptions, open the prescription the order was made from." },
          { title: "Compare eye by eye", body: "Check sphere, cylinder, axis and add for the right eye and the left eye against the order and the lab ticket." },
          { title: "Check the fit", body: "Confirm the pupillary distance, lens type and coating match what was ordered, and adjust the frame on the patient." },
          { title: "Confirm the vision", body: "Ask the patient to read distance and near with the new glasses, and note any complaint before they leave." },
          { title: "Complete the order", body: "Mark the optical order collected, record the delivered date and settle any balance." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Surgery Bookings", body: "Choose Surgery Bookings from the Eye Clinic group and select New Booking." },
          { title: "Choose the patient and procedure", body: "Select the patient, then the procedure, for example cataract surgery with a lens implant, laser treatment or an injection." },
          { title: "Confirm the eye", body: "Set whether the surgery is on the right eye, the left eye or both. Check this against the exam notes before saving." },
          { title: "Set the date, time and theatre", body: "Enter the date, the time and the theatre so the case appears on the theatre list on the Eye Clinic Overview." },
          { title: "Plan the lens", body: "Enter the lens model and its power in dioptres, and record the biometry notes the plan is based on." },
          { title: "Save the booking", body: "Select Save booking and confirm the case shows the right procedure, eye and status on the list." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open the booking", body: "On Surgery Bookings, open the case you are preparing." },
          { title: "Work down the checklist", body: "Tick each pre-op item as it is done: consent signed, biometry done, blood pressure checked, blood sugar checked, fasting confirmed, pupil dilated, antibiotic drops started, anaesthetic review and lens available." },
          { title: "Record the consent", body: "Tick the consent box only when the signed form exists. A case without it shows a 'no consent' warning on the list." },
          { title: "Confirm the booking", body: "Move the status to confirmed once the checks are complete and the patient has been told when to arrive." },
          { title: "Handle changes early", body: "If a check fails, set the status to postponed or cancelled and tell the patient, rather than leaving the case on the theatre list." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open the completed case", body: "On Surgery Bookings, open the booking after the operation." },
          { title: "Write the outcome", body: "Record what was done, the lens actually implanted, anything unexpected and the post-operative drops." },
          { title: "Set the status to completed", body: "Update the status so the case leaves the upcoming theatre list." },
          { title: "Book the review", body: "Create the post-operative appointment, and record the first-day vision and pressure as a new eye exam." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Billing", body: "Choose Billing from Finance." },
          { title: "Start the invoice", body: "Create a new invoice and select the patient." },
          { title: "Add the lines", body: "Add what the patient is paying for, such as the eye examination, visual field test, frames, lenses, contact lenses or drops." },
          { title: "Record the payment", body: "Enter the amount received and the payment method. Part payments leave a visible balance." },
          { title: "Check it is closed", body: "Save the invoice and confirm the status and the patient's outstanding balance are correct." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Estimates", body: "Choose Estimates from Finance." },
          { title: "Build the quote", body: "Select the patient and add the items, such as frame, lenses, coatings and the professional fee, or the surgery package." },
          { title: "Share it with the patient", body: "Send or print the estimate so the patient can decide with clear figures." },
          { title: "Convert it when accepted", body: "Once the patient agrees, raise the invoice or the optical order from the agreed figures." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Payment Plans", body: "Choose Payment Plans from Finance." },
          { title: "Create the plan", body: "Select the patient, enter the total, the deposit and the instalment amounts and dates." },
          { title: "Record each instalment", body: "Add each payment as it is received so the remaining balance stays accurate." },
          { title: "Watch for missed payments", body: "Review overdue instalments regularly and contact the patient before releasing further work." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Expenses", body: "Choose Expenses from Finance." },
          { title: "Add the expense", body: "Enter the date, category, amount and a short description, for example lens lab invoice, frame stock, drops, rent or equipment servicing." },
          { title: "Keep the proof", body: "Attach or file the receipt reference so the entry can be checked later." },
          { title: "Review by category", body: "Compare categories each month to see where costs are rising." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Inventory", body: "Choose Inventory from Inventory & Supply." },
          { title: "Add your items", body: "Create items for frames, stock lenses, contact lenses, solutions, diagnostic drops, anaesthetics and consumables." },
          { title: "Set quantities and reorder levels", body: "Enter the current quantity and the level at which you want to be warned, so you never run out of a fast-moving frame or drop." },
          { title: "Record expiry dates", body: "Add expiry dates for drops, solutions and contact lenses, and check the expiry alerts before dispensing." },
          { title: "Adjust stock as you use it", body: "Update quantities when items are dispensed or damaged so the counts stay trustworthy." },
        ],
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Suppliers", body: "Choose Suppliers from Inventory & Supply." },
          { title: "Add a supplier", body: "Enter the company name, contact person, phone, email and what they supply." },
          { title: "Note the terms", body: "Record lead times and payment terms so you know how early to order lenses and frames." },
          { title: "Keep details current", body: "Update or remove a supplier when contacts change, so orders do not go to the wrong place." },
        ],
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open Purchase Orders", body: "Choose Purchase Orders from Inventory & Supply." },
          { title: "Create the order", body: "Select the supplier and add the items and quantities you need." },
          { title: "Send and track it", body: "Send the order to the supplier and keep its status current while you wait." },
          { title: "Receive the delivery", body: "Check what arrived against the order, then record the received quantities so stock levels update." },
          { title: "Query shortfalls", body: "Raise missing or damaged items with the supplier before closing the order." },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the date range", body: "Set the from and to dates for the period you want to review." },
          { title: "Read the key numbers", body: "Review the headline cards, the revenue trend, the service mix and the clinician performance table." },
          { title: "Export the results", body: "Select Export to download the report for sharing or further review." },
        ],
      },
      {
        ...
        level: "Advanced",
        steps: [
          { title: "Open Advanced Analytics", body: "Choose Advanced Analytics from the Reports group. Access is limited to the roles your clinic allows." },
          { title: "Start with the overview", body: "Review the headline metrics before narrowing your investigation." },
          { title: "Compare the charts", body: "Compare revenue, activity and performance across the available periods or categories." },
          { title: "Turn an insight into action", body: "Adjust schedules, frame and lens stock, pricing or recall lists, then review the next period." },
        ],
      },
      {
        ...
        level: "Advanced",
        steps: [
          { title: "Open Profitability", body: "Choose Profitability from Finance when your role has access." },
          ...
          { title: "Separate optical from clinical", body: "Compare examination income with frame, lens and contact lens income to see which side is carrying the clinic." },
          { title: "Follow up in the source screen", body: "Use Billing, Expenses, Optical Orders or Reports to investigate the record behind an unexpected figure." },
        ],
      },
    ],
  },
