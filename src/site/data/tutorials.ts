    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open your clinic dashboard", body: "Sign in and choose your clinic. The Dashboard is the starting point for appointments, patients, eye clinic work, finance and stock.", image: "/tutorials/eye/appointments.png", imageAlt: "Open your clinic dashboard — Clinexus eye clinic dashboard" },
          { title: "Open the Eye Clinic group", body: "The Eye Clinic group in the sidebar holds Eye Exams, Optical Prescriptions, Contact Lenses, Optical Orders, Diagnostics, Eye Results, Eye Charts and Surgery Bookings.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Open the Eye Clinic group — Clinexus eye clinic dashboard" },
          { title: "Use the other sidebar groups", body: "Open Patient Care for patients, appointments, the waiting list, schedules, consents and reviews. Use Finance for money matters, Reports for performance, and Inventory & Supply for frames, lenses and drugs.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Use the other sidebar groups — Clinexus eye clinic dashboard" },
          ...
          { title: "Check your access", body: "If a page is missing from your sidebar, ask an owner or admin to review your staff role. Access to clinical pages, billing and settings depends on that role.", image: "/tutorials/eye/billing.png", imageAlt: "Check your access — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Save your clinic details", body: "Enter the clinic information your team and patients should see, optionally select Upload Logo, then select Save Changes.", image: "/tutorials/eye/documents.png", imageAlt: "Save your clinic details — Clinexus eye clinic dashboard" },
          { title: "Add your team", body: "Open Staff, select Add Staff, and enter each person's details and role. Optometrists and assistants need clinical access; front-desk staff need appointments, orders and billing.", image: "/tutorials/eye/appointments.png", imageAlt: "Add your team — Clinexus eye clinic dashboard" },
          ...
          { title: "Add your services", body: "Open your service catalogue and add the visits you charge for, such as full eye examination, refraction, contact lens fitting, visual field test and follow-up review.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Add your services — Clinexus eye clinic dashboard" },
          { title: "Do a practice run", body: "Register a test patient, book an appointment, record a short eye exam and delete the records afterwards so your team can practise safely.", image: "/tutorials/eye/eye-exams.png", imageAlt: "Do a practice run — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Upload your logo", body: "Select Upload Logo, choose the clinic logo, and check that it appears correctly before saving.", image: "/tutorials/eye/documents.png", imageAlt: "Upload your logo — Clinexus eye clinic dashboard" },
          { title: "Turn on the right notifications", body: "Open Notifications and choose the switches for appointment reminders, payment alerts and low stock alerts so the team is warned about frames, lenses and drops running out.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Turn on the right notifications — Clinexus eye clinic dashboard" },
          { title: "Manage members and rooms", body: "If you are an admin, use Members & Roles to edit details or change a role, and set up your consulting and refraction rooms.", image: "/tutorials/eye/eye-exams.png", imageAlt: "Manage members and rooms — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Write your clinic introduction", body: "Enter the clinic name, tagline, about text and contact details patients should see.", image: "/tutorials/eye/patients.png", imageAlt: "Write your clinic introduction — Clinexus eye clinic dashboard" },
          { title: "List your eye care services", body: "Add the services you want to advertise, such as eye examinations, glasses dispensing, contact lens fitting, glaucoma screening and cataract assessment.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "List your eye care services — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Add a product", body: "Create the product with its name, description, price, images and stock. Typical items are frames, single vision and anti-glare lenses, contact lens solutions, lubricating drops and sunglasses.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Add a product — Clinexus eye clinic dashboard" },
          { title: "Keep prices and stock accurate", body: "Update price and stock whenever your supplier costs or shelf counts change so patients are not sold items you do not have.", image: "/tutorials/eye/suppliers.png", imageAlt: "Keep prices and stock accurate — Clinexus eye clinic dashboard" },
          { title: "Process incoming orders", body: "Review new orders, move each one through its status as you prepare and hand it over, and check the payment before release.", image: "/tutorials/eye/billing.png", imageAlt: "Process incoming orders — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Read an entry", body: "Each entry shows the person, the action and the record affected, so you can trace an edited prescription, order amount or invoice.", image: "/tutorials/eye/billing.png", imageAlt: "Read an entry — Clinexus eye clinic dashboard" },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Search before you create", body: "Always search the name or phone number first. One record per patient keeps exams, prescriptions and orders together.", image: "/tutorials/eye/optical-prescriptions.png", imageAlt: "Search before you create — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Open the Eye History tab", body: "The eye records tab summarises the patient's eye exams, optical prescriptions, contact lenses, optical orders, diagnostic studies and surgery in one place.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Open the Eye History tab — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Open the patient profile", body: "Search Patients and select the patient whose visit you are documenting.", image: "/tutorials/eye/documents.png", imageAlt: "Open the patient profile — Clinexus eye clinic dashboard" },
          { title: "Capture the background", body: "Record the presenting complaint, how long it has lasted, previous glasses or contact lens wear, eye surgery, family history of glaucoma and any current eye drops.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Capture the background — Clinexus eye clinic dashboard" },
          { title: "Document the visit", body: "Enter what the patient reported, what you found, your assessment and the plan, keeping right eye and left eye findings clearly separated.", image: "/tutorials/eye/documents.png", imageAlt: "Document the visit — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Sign the form", body: "Open the patient consent and select Sign to record the patient's completed consent. Dilation and surgery consents must be signed before the procedure starts.", image: "/tutorials/eye/surgery-bookings.png", imageAlt: "Sign the form — Clinexus eye clinic dashboard" },
          { title: "Keep templates ready", body: "Use New Template for your own wording, or upload a scanned form you already use on paper.", image: "/tutorials/eye/documents.png", imageAlt: "Keep templates ready — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and service", body: "Select the patient, the optometrist and the visit type, such as full eye examination, refraction only, contact lens fitting, visual field test or post-operative review.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Choose the patient and service — Clinexus eye clinic dashboard" },
          { title: "Allow enough time", body: "Book longer slots for first visits, dilated examinations and contact lens teaching, and shorter slots for collections and quick reviews.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Allow enough time — Clinexus eye clinic dashboard" },
          ...
          { title: "Save the booking", body: "Complete the dialog, then confirm the appointment appears in the schedule or list view.", image: "/tutorials/eye/schedules.png", imageAlt: "Save the booking — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Add the visit details", body: "Choose the clinician, the reason for the visit and any notes. Flag sudden vision loss, eye injury or severe pain so the patient is seen first.", image: "/tutorials/eye/patients.png", imageAlt: "Add the visit details — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Check in from Appointments", body: "Find the appointment and select Check in when the patient arrives.", image: "/tutorials/eye/waiting-list.png", imageAlt: "Check in from Appointments — Clinexus eye clinic dashboard" },
          ...
          { title: "Call the next patient", body: "Select Call Next to move the next patient forward, or check a patient in directly from this page.", image: "/tutorials/eye/patients.png", imageAlt: "Call the next patient — Clinexus eye clinic dashboard" },
          { title: "Keep dilated patients visible", body: "Note when drops were instilled so the patient is called back at the right time, and mark the visit complete when they leave.", image: "/tutorials/eye/patients.png", imageAlt: "Keep dilated patients visible — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Block out non-clinical time", body: "Reserve time for surgery lists, home visits, admin and leave so those slots cannot be booked.", image: "/tutorials/eye/surgery-bookings.png", imageAlt: "Block out non-clinical time — Clinexus eye clinic dashboard" },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and date", body: "Search the patient by name or phone in the picker, then set the exam date. On an existing exam the patient stays locked, so only the findings can be edited.", image: "/tutorials/eye/patients.png", imageAlt: "Choose the patient and date — Clinexus eye clinic dashboard" },
          { title: "Record the complaint", body: "Enter the chief complaint in the patient's own words, for example blurred distance vision, headaches when reading or gritty eyes.", image: "/tutorials/eye/patients.png", imageAlt: "Record the complaint — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Choose the study and eye", body: "Select the patient, the study type, and whether it applies to the right eye, the left eye or both.", image: "/tutorials/eye/patients.png", imageAlt: "Choose the study and eye — Clinexus eye clinic dashboard" },
          ...
          { title: "Attach the report", body: "Add the file name and a link to the stored report or image so colleagues can open the original.", image: "/tutorials/eye/reports.png", imageAlt: "Attach the report — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Select the patient", body: "Use the patient card to pick a patient. The card also summarises their latest exam pressure, vision, cup/disc ratio and diagnosis.", image: "/tutorials/eye/patients.png", imageAlt: "Select the patient — Clinexus eye clinic dashboard" },
          ...
          { title: "Open the original file", body: "Select the file link on a row to open the stored report, and use the Graphs button to move to the trend view.", image: "/tutorials/eye/reports.png", imageAlt: "Open the original file — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Select the patient", body: "Pick the patient in the picker. The badges show how many fundus, OCT, visual field and other studies they have.", image: "/tutorials/eye/patients.png", imageAlt: "Select the patient — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Check the activity cards", body: "Read exams today, prescriptions issued, active contact lens wearers, open optical orders, upcoming surgeries and diagnostic studies.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Check the activity cards — Clinexus eye clinic dashboard" },
          ...
          { title: "Work the alert lists", body: "Follow up raised pressure above 21 mmHg, the glaucoma watch list, today's theatre list, contact lens aftercare that is due and prescriptions expiring soon.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Work the alert lists — Clinexus eye clinic dashboard" },
          { title: "Start work from here", body: "Select New Eye Exam to go straight into recording a visit, and review the common diagnoses chart to see what your clinic is treating most.", image: "/tutorials/eye/eye-exams.png", imageAlt: "Start work from here — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and type", body: "Select the patient, then choose the prescription type: distance, reading, bifocal, progressive, computer or contact lens.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Choose the patient and type — Clinexus eye clinic dashboard" },
          { title: "Set the dates", body: "Enter the issue date and the expiry date. Expiring prescriptions are listed on the Eye Clinic Overview so patients can be recalled.", image: "/tutorials/eye/eye-overview.png", imageAlt: "Set the dates — Clinexus eye clinic dashboard" },
          ...
          { title: "Add the fitting details", body: "Enter pupillary distance in mm, base curve, diameter, the lens brand and any notes for the dispenser.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Add the fitting details — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and date", body: "Select the patient and set the fitting date.", image: "/tutorials/eye/patients.png", imageAlt: "Choose the patient and date — Clinexus eye clinic dashboard" },
          ...
          { title: "Book aftercare", body: "Set the aftercare date so the patient appears on the aftercare-due list on the Eye Clinic Overview.", image: "/tutorials/eye/eye-overview.png", imageAlt: "Book aftercare — Clinexus eye clinic dashboard" },
          { title: "Keep the status current", body: "Move the fitting from trial to dispensed, then to aftercare, or to discontinued if the patient stops wearing lenses.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Keep the status current — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Identify the order", body: "Select the patient, then enter your order number and the order date so the job can be traced.", image: "/tutorials/eye/patients.png", imageAlt: "Identify the order — Clinexus eye clinic dashboard" },
          ...
          { title: "Add the lab and promised date", body: "Enter the lab or supplier and the date you promised the glasses, so you can see which jobs are late.", image: "/tutorials/eye/suppliers.png", imageAlt: "Add the lab and promised date — Clinexus eye clinic dashboard" },
          ...
          { title: "Close the order", body: "When the patient collects, enter the delivered date, confirm the balance is settled, and select Save order.", image: "/tutorials/eye/patients.png", imageAlt: "Close the order — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Confirm the vision", body: "Ask the patient to read distance and near with the new glasses, and note any complaint before they leave.", image: "/tutorials/eye/patients.png", imageAlt: "Confirm the vision — Clinexus eye clinic dashboard" },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Set the date, time and theatre", body: "Enter the date, the time and the theatre so the case appears on the theatre list on the Eye Clinic Overview.", image: "/tutorials/eye/eye-overview.png", imageAlt: "Set the date, time and theatre — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Confirm the booking", body: "Move the status to confirmed once the checks are complete and the patient has been told when to arrive.", image: "/tutorials/eye/patients.png", imageAlt: "Confirm the booking — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Book the review", body: "Create the post-operative appointment, and record the first-day vision and pressure as a new eye exam.", image: "/tutorials/eye/eye-exams.png", imageAlt: "Book the review — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Add the lines", body: "Add what the patient is paying for, such as the eye examination, visual field test, frames, lenses, contact lenses or drops.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Add the lines — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Build the quote", body: "Select the patient and add the items, such as frame, lenses, coatings and the professional fee, or the surgery package.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Build the quote — Clinexus eye clinic dashboard" },
          ...
          { title: "Convert it when accepted", body: "Once the patient agrees, raise the invoice or the optical order from the agreed figures.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Convert it when accepted — Clinexus eye clinic dashboard" },
        ],
      },
      {
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Add the expense", body: "Enter the date, category, amount and a short description, for example lens lab invoice, frame stock, drops, rent or equipment servicing.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Add the expense — Clinexus eye clinic dashboard" },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Add your items", body: "Create items for frames, stock lenses, contact lenses, solutions, diagnostic drops, anaesthetics and consumables.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Add your items — Clinexus eye clinic dashboard" },
          { title: "Set quantities and reorder levels", body: "Enter the current quantity and the level at which you want to be warned, so you never run out of a fast-moving frame or drop.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Set quantities and reorder levels — Clinexus eye clinic dashboard" },
          { title: "Record expiry dates", body: "Add expiry dates for drops, solutions and contact lenses, and check the expiry alerts before dispensing.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Record expiry dates — Clinexus eye clinic dashboard" },
          { title: "Adjust stock as you use it", body: "Update quantities when items are dispensed or damaged so the counts stay trustworthy.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Adjust stock as you use it — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Note the terms", body: "Record lead times and payment terms so you know how early to order lenses and frames.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Note the terms — Clinexus eye clinic dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Create the order", body: "Select the supplier and add the items and quantities you need.", image: "/tutorials/eye/suppliers.png", imageAlt: "Create the order — Clinexus eye clinic dashboard" },
          { title: "Send and track it", body: "Send the order to the supplier and keep its status current while you wait.", image: "/tutorials/eye/suppliers.png", imageAlt: "Send and track it — Clinexus eye clinic dashboard" },
          ...
          { title: "Query shortfalls", body: "Raise missing or damaged items with the supplier before closing the order.", image: "/tutorials/eye/suppliers.png", imageAlt: "Query shortfalls — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Turn an insight into action", body: "Adjust schedules, frame and lens stock, pricing or recall lists, then review the next period.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Turn an insight into action — Clinexus eye clinic dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Compare revenue and expenses", body: "Review the revenue, expense and margin views to see what is driving the current result.", image: "/tutorials/eye/expenses.png", imageAlt: "Compare revenue and expenses — Clinexus eye clinic dashboard" },
          { title: "Separate optical from clinical", body: "Compare examination income with frame, lens and contact lens income to see which side is carrying the clinic.", image: "/tutorials/eye/contact-lenses.png", imageAlt: "Separate optical from clinical — Clinexus eye clinic dashboard" },
          { title: "Follow up in the source screen", body: "Use Billing, Expenses, Optical Orders or Reports to investigate the record behind an unexpected figure.", image: "/tutorials/eye/optical-orders.png", imageAlt: "Follow up in the source screen — Clinexus eye clinic dashboard" },
        ],
      },
    ],
  },
